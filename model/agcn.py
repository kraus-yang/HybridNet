...
class shuffle_module(nn.Module):
    def __init__(self,in_channels,num_point):
        super(shuffle_module,self).__init__()
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,drop_out=0.0):
        ...
        self.l1 = TCN_GCN_unit(3, 64, A,kt=1, residual=False)
        self.l2 = TCN_GCN_unit(64, 64, A,kt=3)
        self.l3 = TCN_GCN_unit(64, 64, A)
        self.l4 = TCN_GCN_unit(64, 64, A)
        self.shuffle = shuffle_module(64, num_point)
        self.backbone = resnest18()
